...
import { PostgresManagerStack } from '../infrastructure/postgres-manager/stage/deploy/stack';
import { getPostgresManagerStackProps } from '../infrastructure/postgres-manager/stage/deploy/config';
...
describe('cdk-nag-authorization-stack', () => {
  ...
  const deployStack = new PostgresManagerStack(app, 'PostgresManagerStack', {
    ...getPostgresManagerStackProps(),
    env: {
      account: '123456789',
